// Questions data for the MBTI career test system
const TEST_QUESTIONS = {
    ...
    ei: [
        ...
        },
        {
            ...
            options: [
                { text: "(A) જાહેરમાં મળેલી વધુ ગમે..", dimension: "E", weight: 3 },
                { text: "(B) વ્યક્તિગત રીતે મળેલી વધુ કિંમતી લાગે..", dimension: "I", weight: 3 }
            ]
        },
        {
            question: "હું ક્યારે એન્જોય કે રિલેક્સ અનુભવું છું:",
            options: [
                { text: "(A) ગરમાગરમ ચર્ચાઓથી અને હસવાથી..", dimension: "E", weight: 3 },
                { text: "(B) શાંતિભર્યા વિચાર અને ચિંતનથી..", dimension: "I", weight: 3 }
            ]
        },
        {
            question: "મારે માટે વધુ આરામદાયક છે:",
            options: [
                { text: "(A) સમૂહ પ્રવૃત્તિઓ..", dimension: "E", weight: 3 },
                { text: "(B) વ્યક્તિગત પ્રવૃત્તિઓ..", dimension: "I", weight: 3 }
            ]
        },
        {
            question: "મારી વાતચીતની શૈલી કેવી છે:",
            options: [
                { text: "(A) ખુલ્લી અને સરળ..", dimension: "E", weight: 3 },
                { text: "(B) વિચારેલી અને શાંત..", dimension: "I", weight: 3 }
            ]
        },
        {
            question: "હું લોકો સાથે વાત કરતી વખતેઃ",
            options: [
                { text: "(A) તરત જવાબ આપું..", dimension: "E", weight: 3 },
                { text: "(B) વિચાર્યા પછી જવાબ આપું..", dimension: "I", weight: 3 }
            ]
        },
        {
            question: "જયારે હું કોઈ નવા સ્થાન પર જાવ ત્યારે:",
            options: [
                { text: "(A) તરત મિત્ર બનાવી શકું..", dimension: "E", weight: 3 },
                { text: "(B) સમય લઈ લોકો સાથે સંબંધ વિકસાવું..", dimension: "I", weight: 3 }
            ]
        }
    ],
    ...
    sn: [
        ...
        // Add 10 more S vs N questions here...
        {
    ...
    tf: [
        ...
        // Add 10 more T vs F questions here...
        {
    ...
    jp: [
        ...
        // Add 10 more J vs P questions here...
        {
